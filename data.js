const wordPairs = [
    ...
    { majority: 'Maçã', infiltrator: 'Pera', category: 'Fruta' },
    { majority: 'Pera', infiltrator: 'Maçã', category: 'Fruta' },
    { majority: 'Calça', infiltrator: 'Bermuda', category: 'Roupa' },
    { majority: 'Bermuda', infiltrator: 'Calça', category: 'Roupa' },
    { majority: 'Frio', infiltrator: 'Calor', category: 'Sensação' },
    { majority: 'Calor', infiltrator: 'Frio', category: 'Sensação' },
    { majority: 'Samba', infiltrator: 'Pagode', category: 'Música' },
    { majority: 'Pagode', infiltrator: 'Samba', category: 'Música' },
    { majority: 'Refrigerante', infiltrator: 'Suco', category: 'Bebida' },
    { majority: 'Suco', infiltrator: 'Refrigerante', category: 'Bebida' },
    { majority: 'Tênis', infiltrator: 'Sapato', category: 'Calçado' },
    { majority: 'Sapato', infiltrator: 'Tênis', category: 'Calçado' },
    { majority: 'Ônibus', infiltrator: 'Trem', category: 'Transporte' },
    { majority: 'Trem', infiltrator: 'Ônibus', category: 'Transporte' },
    { majority: 'Facebook', infiltrator: 'Instagram', category: 'Rede Social' },
    { majority: 'Instagram', infiltrator: 'Facebook', category: 'Rede Social' },
    { majority: 'Natal', infiltrator: 'Ano Novo', category: 'Feriado' },
    { majority: 'Ano Novo', infiltrator: 'Natal', category: 'Feriado' },
    { majority: 'Batman', infiltrator: 'Superman', category: 'Herói' },
    { majority: 'Superman', infiltrator: 'Batman', category: 'Herói' },
    { majority: 'Vampiro', infiltrator: 'Lobisomem', category: 'Monstro' },
    { majority: 'Lobisomem', infiltrator: 'Vampiro', category: 'Monstro' },
